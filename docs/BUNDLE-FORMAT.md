...
R8s parses these bundles to provide offline cluster analysis and automated triage without requiring API access.
...
r8s analyze ./support-bundle-folder/
```
...
6. **Ready** → bundle loaded, Engine is ready for queries/analysis
...
# Analyze
r8s analyze ./w-guard-wg-cp-svtk6-lqtxw-2025-11-27_04_19_09/
```

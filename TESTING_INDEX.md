...
1. **[TESTING_SUMMARY_2025_11_28.md](TESTING_SUMMARY_2025_11_28.md)**
...
| Bug ID | Severity | Status | Location | Fix Guide |
|--------|----------|--------|----------|-----------|
| BUG-001 | CRITICAL | Awaiting Fix | `internal/tui/app.go:1395-1412` | [BUG_001_FIX_GUIDE.md](BUG_001_FIX_GUIDE.md) |
